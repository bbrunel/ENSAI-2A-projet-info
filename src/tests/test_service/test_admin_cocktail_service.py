...
class Test_admin_cocktail_service_unitaire:
    ...
    def test_supprimer_cocktail_erreur_cocktail_inexistant(self):
        ...
        #WHEN
        with patch("service.cocktail_service.CocktailService.verifier_cocktail", 
        return_value=None):
...
class Test_admin_cocktail_service_integration:
    ...
    def test_ajout_cocktail_erreur_deja_existant(self):
        ...
        #WHEN&THEN
        with pytest.raises(ValueError):
            AdminCocktailService().ajout_cocktail(ckt.nom, 
            ckt.tags, ckt.categorie, ckt.iba, ckt.alcoolise, 
            ckt.verre, ckt.instructions)
